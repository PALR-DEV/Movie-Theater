                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 text-zinc-300">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-medium sm:text-sm md:text-base">{ticketTime}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" />
                                        </svg>
                                        <span className="text-xs font-medium sm:text-sm md:text-base whitespace-nowrap">{TicketDate}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M7 3a1 1 0 012 0v1h2V3a1 1 0 112 0v1h2a2 2 0 012 2v2H3V6a2 2 0 012-2h2V3zM3 9h18v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                        </svg>
                                        <span className="text-xs font-medium sm:text-sm md:text-base">Room {sala}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
