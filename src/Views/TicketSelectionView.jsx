...
const TicketSelectionView = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            <button className="fixed top-6 left-6 z-10 text-white hover:text-zinc-300 transition-all duration-300 
                    ...
                    <div className="bg-zinc-900/50 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl transform transition-all duration-500 ">
                        <div className="relative h-72 md:h-96 overflow-hidden">
                            ...
                            <img
                                ...
                                src="https://images.fandango.com/ImageRenderer/0/0/redesign/static/img/default_poster.png/0/images/masterrepository/Fandango/239973/starwarsepisodeiii-rerelease-posterart.jpg"
                                alt="Movie Poster"
