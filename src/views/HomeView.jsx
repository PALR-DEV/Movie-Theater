                ...
                <div className="container mx-auto px-6 sm:px-8 md:px-12 py-3">
                    <div className="flex justify-between items-center">
                        ...
                        <button 
                            ...
                            className="md:hidden relative z-10 p-6 -mr-6 touch-manipulation"
                            aria-label="Toggle menu"
                        >
                            <div className="w-8 h-8 relative">
                                <span className={`absolute h-0.5 w-full bg-white transform transition-all duration-300 ${
                                    mobileMenuOpen ? 'rotate-45 top-4' : 'top-1.5'
                                }`}></span>
                                <span className={`absolute h-0.5 w-full bg-white top-4 transition-all duration-200 ${
                                    mobileMenuOpen ? 'opacity-0' : 'opacity-100'
                                }`}></span>
                                <span className={`absolute h-0.5 w-full bg-white transform transition-all duration-300 ${
                                    mobileMenuOpen ? '-rotate-45 top-4' : 'top-6.5'
                                }`}></span>
                            </div>
                        </button>
